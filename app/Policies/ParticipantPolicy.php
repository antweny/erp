...
class ParticipantPolicy
{
    ...
    {
        return $admin->can('participant-create');
    }
    ...
    {
        return $admin->can('participant-read');
    }
    ...
    {
        return $admin->can('participant-update');
    }
    ...
    {
        return $admin->can('participant-delete');
    }
    ...
    {
        return $admin->can('participant-import');
    }
}
