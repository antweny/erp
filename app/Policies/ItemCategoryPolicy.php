...
class ItemCategoryPolicy
{
    ...
    {
        return $employee->can('itemCategory-create');
    }
    ...
    {
        return $employee->can('itemCategory-read');
    }
    ...
    {
        return $employee->can('itemCategory-update');
    }
    ...
    {
        return $employee->can('itemCategory-delete');
    }
    ...
    {
        return $employee->can('itemCategory-import');
    }
}
