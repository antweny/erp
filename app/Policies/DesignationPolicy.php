...
class DesignationPolicy
{
    ...
    {
        return $employee->can('designation-create');
    }
    ...
    {
        return $employee->can('designation-read');
    }
    ...
    {
        return $employee->can('designation-update');
    }
    ...
    {
        return $employee->can('designation-delete');
    }
    ...
    {
        return $employee->can('designation-import');
    }
