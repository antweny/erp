...
class DesignationPolicy
{
    ...
    {
        return $admin->can('designation-create');
    }
    ...
    {
        return $admin->can('designation-read');
    }
    ...
    {
        return $admin->can('designation-update');
    }
    ...
    {
        return $admin->can('designation-delete');
    }
    ...
    {
        return $admin->can('designation-import');
    }
