...
class ParticipantRolePolicy
{
    ...
    {
        return $employee->can('participantRole-create');
    }
    ...
    {
        return $employee->can('participantRole-read');
    }
    ...
    {
        return $employee->can('participantRole-update');
    }
    ...
    {
        return $employee->can('participantRole-delete');
    }
}
