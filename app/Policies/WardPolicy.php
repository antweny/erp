...
class WardPolicy
{
    ...
    {
        return $employee->can('ward-create');
    }
    ...
    {
        return $employee->can('ward-update');
    }
    ...
    {
        return $employee->can('ward-delete');
    }
    ...
    {
        return $employee->can('ward-import');
    }
}
