...
class StreetPolicy
{
    ...
    {
        return $employee->can('street-create');
    }
    ...
    {
        return $employee->can('street-read');
    }
    ...
    {
        return $employee->can('street-update');
    }
    ...
    {
        return $employee->can('street-delete');
    }
    ...
    {
        return $employee->can('street-import');
    }
}
