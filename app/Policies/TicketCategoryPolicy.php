...
class TicketCategoryPolicy
{
    ...
    {
        return $admin->can('ticketCategory-create');
    }
    ...
    {
        return $admin->can('ticketCategory-read');
    }
    ...
    {
        return $admin->can('ticketCategory-update');
    }
    ...
    {
        return $admin->can('ticketCategory-delete');
    }
    ...
    {
        return $admin->can('ticketCategory-import');
    }
}
