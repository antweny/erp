...
class ItemUnitPolicy
{
    ...
    {
        return $employee->can('itemUnit-create');
    }
    ...
    {
        return $employee->can('itemUnit-read');
    }
    ...
    {
        return $employee->can('itemUnit-update');
    }
    ...
    {
        return $employee->can('itemUnit-delete');
    }
    ...
    {
        return $employee->can('itemUnit-import');
    }
}
