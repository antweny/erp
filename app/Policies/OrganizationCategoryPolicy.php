...
class OrganizationCategoryPolicy
{
    ...
    {
        return $employee->can('organizationCategory-create');
    }
    ...
    {
        return $employee->can('organizationCategory-read');
    }
    ...
    {
        return $employee->can('organizationCategory-update');
    }
    ...
    {
        return $employee->can('organizationCategory-delete');
    }
}
