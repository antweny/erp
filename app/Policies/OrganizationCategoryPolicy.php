...
class OrganizationCategoryPolicy
{
    ...
    {
        return $admin->can('organizationCategory-create');
    }
    ...
    {
        return $admin->can('organizationCategory-read');
    }
    ...
    {
        return $admin->can('organizationCategory-update');
    }
    ...
    {
        return $admin->can('organizationCategory-delete');
    }
}
