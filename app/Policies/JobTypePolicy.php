...
class JobTypePolicy
{
    ...
    {
        return $admin->can('jobType-create');
    }
    ...
    {
        return $admin->can('jobType-update');
    }
    ...
    {
        return $admin->can('jobType-delete');
    }
    ...
    {
        return $admin->can('jobType-import');
    }
}
