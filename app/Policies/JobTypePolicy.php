...
class JobTypePolicy
{
    ...
    {
        return $employee->can('jobType-create');
    }
    ...
    {
        return $employee->can('jobType-read');
    }
    ...
    {
        return $employee->can('jobType-update');
    }
    ...
    {
        return $employee->can('jobType-delete');
    }
    ...
    {
        return $employee->can('jobType-import');
    }
}
