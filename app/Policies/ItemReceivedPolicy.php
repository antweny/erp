...
class ItemReceivedPolicy
{
    ...
    {
        return $employee->can('itemReceived-create');
    }
    ...
    {
        return $employee->can('itemReceived-read');
    }
    ...
    {
        return $employee->can('itemReceived-update');
    }
    ...
    {
        return $employee->can('itemReceived-delete');
    }
    ...
    {
        return $employee->can('itemReceived-import');
    }
