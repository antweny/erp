...
class ItemReceivedPolicy
{
    ...
    {
        return $admin->can('itemReceived-create');
    }
    ...
    {
        return $admin->can('itemReceived-read');
    }
    ...
    {
        return $admin->can('itemReceived-update');
    }
    ...
    {
        return $admin->can('itemReceived-delete');
    }
    ...
    {
        return $admin->can('itemReceived-import');
    }
