...
class OrganizationPolicy
{
    ...
    {
        return $employee->can('organization-create');
    }
    ...
    {
        return $employee->can('organization-read');
    }
    ...
    {
        return $employee->can('organization-update');
    }
    ...
    {
        return $employee->can('organization-delete');
    }
    ...
    {
        return $employee->can('organization-import');
    }
}
