    ...
    <div class="form-group row">
        <div class="col-md-12">
            ...
            <input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }} " value="{{old('name',$educationLevel->name)}}" placeholder="Ex. Degree, Master's" required/>
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            ...
            <textarea name="desc" id="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" rows="5">{{old('desc',$educationLevel->desc)}}</textarea>
