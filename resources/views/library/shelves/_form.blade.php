...
<div class="form-group row">
    <div class="col-md-12">
        <label class="col-form-label">Shelf Name <span class="star">*</span></label>
        <input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }} " value="{{$shelf->name}}" placeholder="Ex. Subject" required/>
...
<div class="form-group row">
    <div class="col-sm-12">
        ...
        <textarea name="desc" id="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" rows="5">{{$shelf->desc}}</textarea>
