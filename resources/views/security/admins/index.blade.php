    ...
    <div class="ca card">
        <div class="card-header">
            <div class="float-left">
                <h4 class="header-title">Administrators List</h4>
            </div>
            <div class="float-right">
                <a class="btn btn-success" href="#newRecord" title="New Record" data-toggle="modal"><i class="fa fa-plus"></i> New Admin</a>
            </div>
        </div>
        <div class="card-body">
