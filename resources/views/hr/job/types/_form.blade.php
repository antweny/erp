    ...
    <div class="form-group row">
        <div class="col-md-12">
            ...
            <input type="text" name="name" id="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }} " value="{{old('name',$jobType->name)}}" placeholder="Ex. Tanzania, Kenya" required/>
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            ...
            <textarea name="desc" id="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" rows="5">{{old('desc',$jobType->desc)}}</textarea>
    ...
    <div class="form-group row justify-content-center">
        <div class="col-md-6 float-left">
            <a class="btn btn-dark" href="{{route('jobTypes.index')}}">Cancel</a>
        </div>
        <div class="col-md-6">
